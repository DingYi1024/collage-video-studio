...
SURFACES: dict[str, tuple[str, ...]] = {
    "composition": (
        ...
        "workspace/src/remotion/Root.tsx",
    ...
    "provider": (
        ...
        "scripts/external_media.py",
        "scripts/replicate_backend.py",
    ...
    "protocol": (
        ...
        "scripts/action_proof.py",
        "scripts/creative_quality.py",
        "scripts/production_remotion.py",
